...
### Структура формулы
Формула состоит из шагов, описывающих маршрут алгоритма по генеалогическому древу, а также вспомогательных символов.
**Шаги включают в себя указатели направлений**:
 - ELDRE - шаг в сторону предков;
 - UNG - шаг в сторону потомков;
 - LIK - шаг в сторону супруга;
**Также шаги включают в себя указатели гендера**(ставятся в круглых скобках после указателей направления):
 - M - мужчина;
 - W - женщина;
Получается список возможных шагов в формулах:
 - ELDRE(M);
 - ELDRE(W);
 - UNG(M);
 - UNG(W);
 - LIK(M);
 - LIK(W);
**Шаги внутри формулы разделяются знаком "/".** Пример: ELDRE(M)/LIK(M).
